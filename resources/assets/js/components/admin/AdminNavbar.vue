<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index.html">Coates</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
                    <router-link to="/admin/it-imports" class="nav-link">
                        <i class="fa fa-fw fa-table"></i>
                        <span class="nav-link-text">It Import</span>
                    </router-link>
                </li>
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
                    <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseOrders"
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseOrders">
                        <li>
                            <router-link to="/admin/orders/single" class="nav-link">
                                <i class="fa fa-fw fa-table"></i>
                                <span class="nav-link-text">Add Single</span>
                            </router-link>
                        </li>
                        <li>
                            <router-link to="/admin/orders/bulk" class="nav-link">
                                <i class="fa fa-fw fa-table"></i>
                                <span class="nav-link-text">Add Bulk</span>
                            </router-link>
                        </li>
                        <li>
                            <router-link to="/admin/orders/history" class="nav-link">
                                <i class="fa fa-fw fa-table"></i>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
                    <router-link to="/admin/it-exports" class="nav-link">
                        <i class="fa fa-fw fa-table"></i>
                        <span class="nav-link-text">It Export</span>
                    </router-link>
                </li>
