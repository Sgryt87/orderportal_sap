    ...
    <div class="container-fluid">
        ...
        <nav aria-label="Page navigation example" v-if="total_pages > 1">
            <ul class="pagination">
                ...
                <li class="page-item" v-if="current_page > 1" @click="navigate_to_the_page(current_page-2)">
                ...
                <li class="page-item" v-if="current_page < total_pages - 5"><a class="page-link">...</a>
                </li>
